  ...
  return (
    <div className="px-6 pt-10 pb-12 text-[14px] leading-relaxed" style={{ color: "var(--ink-soft)" }}>
      ...
      <Sec title="1. 수집하는 정보">
        ...
        생년월일·출생시각 원문은 전달 전 제거됩니다. ③ 결제 정보: 토스페이(비바리퍼블리카)가 직접
        수집·처리하며 회사는 카드번호 등 결제 원문 정보를 보관하지 않습니다. 회사는 주문번호·금액·
        승인시각만 보관합니다.
      </Sec>
      ...
      <Sec title="4. 제3자 제공·위탁">
        결제 처리: 토스페이(비바리퍼블리카) / AI 콘텐츠 생성: Anthropic (생년월일 원문 미포함).
        이 외에 개인정보를 제3자에게 제공하지 않습니다.
      </Sec>
      <Sec title="5. 이용자의 권리">
