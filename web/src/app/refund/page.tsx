...
export default function RefundPage() {
  return (
    <div className="px-6 pt-10 pb-12 text-[14px] leading-relaxed" style={{ color: "var(--ink-soft)" }}>
      ...
      <Sec title="1. 콘텐츠 제공 방식과 이용 기간">
        상세 풀이는 결제 완료 즉시 이용자의 사주 정보로 자동 생성되어 <b>결제일 당일 제공이
        완료</b>됩니다(통상 결제 후 1~2분 이내 열람 가능). 생성된 풀이는 <b>결제일로부터 180일간</b>
        결제한 기기의 브라우저에서 횟수 제한 없이 재열람할 수 있으며, 기간이 지나면 열람이
        종료됩니다. 제공 방식·시점과 재열람 기간은 결제 전 화면에도 동일하게 고지됩니다.
      </Sec>
      <Sec title="2. 환불이 가능한 경우">
        ① 결제 후 <b>콘텐츠를 열람하지 않은 경우</b>: 결제일로부터 7일 이내 전액 환불.
        ② 시스템 오류로 콘텐츠가 정상 제공되지 않은 경우: 전액 환불.
        ③ 중복 결제: 중복분 전액 환불.
      </Sec>
      <Sec title="3. 환불이 제한되는 경우">
