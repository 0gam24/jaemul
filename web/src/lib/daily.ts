...
const TEMPLATES: Record<string, { message: string; tip: string }> = {
  ...
  편재: { message: "뜻밖의 제안이나 정보가 굴러들어올 수 있는 날이에요. 눈과 귀를 열어두세요.", tip: "들어온 제안은 메모만 하고 결정은 하루 재우기" },
  식신: { message: "내 재주를 보여줄수록 돈과 가까워지는 날이에요. 숨기면 아무 일도 안 생겨요.", tip: "후기든 포트폴리오든 결과물 하나 공개하기" },
  상관: { message: "내 재주를 보여줄수록 돈과 가까워지는 날이에요. 숨기면 아무 일도 안 생겨요.", tip: "후기든 포트폴리오든 결과물 하나 공개하기" },
  정인: { message: "오늘 배운 것이 나중에 돈으로 돌아오는 날이에요. 지금은 채우는 시간입니다.", tip: "강의든 책이든 돈 되는 공부 30분" },
  편인: { message: "오늘 배운 것이 나중에 돈으로 돌아오는 날이에요. 지금은 채우는 시간입니다.", tip: "강의든 책이든 돈 되는 공부 30분" },
