...
/** 십성 → 일반 독자용 별명 (쉬운 말이 주인공 원칙 — 쌍마다 기능이 달라 별명도 분리) */
...
- 별명 사전(반드시 이 별명 사용 — 용어는 그 용어가 하는 일로 번역한다):
  · 십신: 정재=월급형 돈(꾸준히 들어오는 돈) / 편재=기회형 돈(한 번에 크게 들어오는 돈) / 정관=책임·자리 / 편관=압박·시험대 / 정인=배움·보호막 / 편인=남다른 감각·눈치 / 식신=즐기면서 나오는 재주 / 상관=튀는 재주·표현력 / 비견=나 같은 사람(동료·경쟁자) / 겁재=내 몫 나눠 갖는 사람
  · 구조: 일간=사주의 주인공인 나 / 원국=타고난 기본 판 / 대운=10년마다 바뀌는 돈의 계절 / 세운=그 해의 날씨 / 용신=나에게 약이 되는 기운 / 신강·신약=밀어붙이는 힘이 센·약한
  · 관계·살: 합=서로 손잡음 / 충=부딪힘·흔들림 / 공망=헛도는 자리 / 천을귀인=도와주는 사람 복 / 도화살=사람이 꼬이는 매력(관계 지출 주의) / 역마살=움직이는 기운(이동·출장) / 육해살=예상 못 한 지출 / 화개살=혼자 파고드는 기운
- 추상 표현은 생활 장면으로 쓴다("재물운이 약하다" 금지 → "통장에 돈이 안 남는다"). 진단으로 끝내지 않는다 — 살·충을 언급했으면 반드시 처방(무엇을 언제 어떻게)까지 잇는다.
...
- 번역 투 금지: "~에 대해", "~를 통해", "~로 인해", "~에 있어", "~하는 것이다", "~라고 할 수 있다" — 조사와 동사로 직접 말한다("돈에 대해 이야기하세요" 금지 → "돈 얘기를 꺼내세요").
- 문맥으로 아는 주어는 생략한다 — "당신은", "이 사주는"을 문단마다 반복하면 실패다.
- 수식어는 아낀다 — 형용사·부사 없이 서는 문장이 기본. 꼭 필요한 수식어만 문장당 1개 이하.
