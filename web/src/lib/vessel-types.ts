...
export const VESSEL_TYPES: Record<VesselCode, VesselType> = {
  ...
  SROJ: {
    ...
    caution: "지금 돈이 안 모이는 건 못 버는 게 아니라 예열 중이라 그래요. 수입이 한번 붙기 시작하면 모이는 속도는 남들보다 빠릅니다",
  ...
  SRXP: {
    ...
    caution: "들어오는 돈마다 갈 곳(생활비·저축·비상금)을 정해 통장을 나눠 두세요. 그게 놋그릇 닦기라, 정리만 해도 광이 납니다",
  ...
  SrXP: {
    ...
    caution: "표주박은 원래 퍼 마시는 그릇이라, 담는 통을 따로 두면 완성됩니다",
  ...
  SrXJ: {
    ...
    caution: "샘 주변이 넓어지면 고이는 돈이 달라져요. 이자 한 푼, 부업 하나라도 돈 들어오는 길을 하나만 더 만들어 보세요",
  ...
  WROP: {
    ...
    caution: "소쿠리에 비닐 한 장 깔듯, 자동이체 하나만 걸면 새던 게 담깁니다",
  ...
  WROJ: {
    ...
    strengths: ["모이는 속도가 남다른 저축 체질", "목돈 만드는 인내심"],
    caution: "1년에 한 번 뚜껑 열어 굴리는 날을 정해 보세요. 항아리가 해마다 한 뼘씩 커집니다",
  ...
  WRXP: {
    ...
    strengths: ["투명한 돈 관리로 쌓이는 신용", "같이 벌 사람이 모이는 상"],
    caution: "유리병은 부딪힐 자리만 피하면 오래가요. 변동 큰 판만 걸러도 충분합니다",
  ...
  WRXJ: {
    ...
    caution: "적금·투자를 중간에 자꾸 깨면 장맛이 안 들어요. 조급해지는 시기에 한 번만 버티면 됩니다",
